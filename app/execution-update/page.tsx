              ...
              {[0, 1, 2, 3].map((index) => (
                ...
                >
                  ...
                  <div ref={welcomeContentRefs[index]} className="lg-content p-6">
                    <div className="text-center">
                      ...
                      <p className="text-black/90 mb-4">
                        Project execution and implementation progress
                      </p>
                      
                      <div className="text-left space-y-2 text-black/90 max-w-md mx-auto">
                        <h3 className="text-lg font-semibold mb-3 text-black text-center">Execution Metrics</h3>
                        <p><strong>Tasks Completed:</strong> 18</p>
                        <p><strong>Tasks In Progress:</strong> 7</p>
                        <p><strong>Blocked Items:</strong> 2</p>
                        <p><strong>On Track:</strong> Yes</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="lg-filter-layer">
                    <div ref={welcomeBoxRefs[index]} id={`liquid-glass-exec-welcome-${index}`} className="glass-box" />
                  </div>
                </div>
              ))}
            </div>
